// localpki-core — implémentation des protocoles du papier LocalPKI
// (Dumas, Lafourcade, Melemedjian, Orfila, Thoniel, 2019)
//
// Cette crate est une bibliothèque pure : aucune dépendance réseau, aucun I/O.
// Elle peut être testée et utilisée indépendamment du serveur.
